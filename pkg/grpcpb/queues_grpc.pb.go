...
//
// QueuesService provides queue operations over a bidirectional stream.
type QueuesServiceClient interface {
	// Connect opens a bidirectional stream for sending queue commands and receiving responses.
...
func RegisterQueuesServiceServer(s grpc.ServiceRegistrar, srv QueuesServiceServer) {
	// If the following call panics, it indicates UnimplementedQueuesServiceServer was
