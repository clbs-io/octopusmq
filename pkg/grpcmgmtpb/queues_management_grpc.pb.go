...
func (UnimplementedManagementServiceServer) ResizeQueue(context.Context, *protobuf.ResizeQueueRequest) (*emptypb.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ResizeQueue not implemented")
}
